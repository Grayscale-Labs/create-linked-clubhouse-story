...
beforeEach(() => {
  process.env["INPUT_SHORTCUT-TOKEN"] = "fake-shortcut-token";
...
afterEach(() => {
  delete process.env["INPUT_SHORTCUT-TOKEN"];
...
test.each([
  ...
  ["prefix-1/sc123", "123"],
  ["prefix-1-sc321", "321"],
  ["prefix/sc5678/suffix", "5678"],
  ["prefix-sc6789/suffix-more", "6789"],
  ["prefix/sc7890-suffix", "7890"],
  ["prefix-sc0987-suffix-extra", "0987"],
